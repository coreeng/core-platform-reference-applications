...
|-------|-----------|-------------|
| Fast Feedback | `reference-python-web-functional` | Push / PR to `main` |
| NFT | `reference-python-web-nft` | Fast Feedback |
| Integration | `reference-python-web-integration` | Fast Feedback |
| Extended Test | `reference-python-web-extended-test` | Daily schedule (22:00 UTC) |
| Prod | `reference-python-web-prod` | Weekday schedule (05:30 UTC) |
